...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
    ...
    \item (TK) add section in conclusions/ paragraph on possible extensions to the code: dense output, regression, GANs, segmentation
    \item (NP+MD)  paragraph on our chosen architecture in the Experiments sections
    \item (TK) add reference to figure (pooling) to the area of orders
    ...
    \item (almost done) TK optional - example of data (CMB (mask) + mass map + radio intensity)
...
%\TK{what are monomials? stable in what sense?}
...
Third, the use of the dropout\TK{was dropout mentioned before?} \nati{Probably not. But to keep it simple, we may just add a footnote or a reference.} layer did not help in the presence of noise.
