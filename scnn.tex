...
matrix where $D_{ii}=d_i$. The graph Fourier basis is defined as the harmonic
decomposition of the graph Laplacian $L=U \Lambda U^*$, where $U$ is the
orthonormal matrix of eigenvectors and $\Lambda$, the diagonal matrix of
eigenvalues.
