...
Now that all the building blocks are defined, let's discuss our proposed spherical CNN architecture, pictured in \figref{architecture}.

\todo{present and discuss the whole CNN architecture.}
