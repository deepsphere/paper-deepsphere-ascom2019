...
\begin{itemize}
    ...
    \item upgrade the plot of pooling (Nathanael)
    ...
    \item finish section on Efficient convolutions (Nathanael)
    \item conclusions
    \item (done!) new simulations with 3 arcmin smoothing
    \item (done!) simulation with cross-validation for the histogram
    \item (Almost done!) Update result section according to the new simulations...
    \item (Almost done!) simulation PSD
