...
% most data generating processes have a small-support autocorrelation function.
...
% good performance was demonstrated for object recognition in images \citep{springenberg2014allconv}.
...
% Contrast the number of parameters to be learned in a FC layer versus the static AV layer.
% FCNs are more sample efficient.
