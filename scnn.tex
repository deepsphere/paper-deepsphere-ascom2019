...
Code, data, and examples are available at \url{https://github.com/SwissDataScienceCenter/DeepSphere}.
...
As the Equal Area isoLatitude Pixelisation (HEALPix)~\citep{gorski2005healpix} is the most popular sampling used in cosmology and astrophysics, we tailored the method to that particular sampling and call it DeepSphere.
...
The main product of this contribution is DeepSphere, a small and easy-to-use python package for the spherical analysis of cosmological data.
