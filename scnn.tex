...
While our construction does not exactly respect their setting (the sampling is not uniform and the graph is not fully connected), we empirically observe a strong correspondence between the eigenmodes of both Laplacians (see \ref{sec:comparison_spherical_harmonics}).
