...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
    ...
    \item (NP) vertex interpretation
    \item (MD) Are you happy with the vertex interpretation in section 3.5 Efficient convolutions?
...
\end{equation}
where $T_n g(m)=g(n-m)$ is (up to a flip) a translation operator. 
...
working on the sphere with theoretically spherical filters (up to the irregularities of the sampling), we could only plot the section of the convoluted Kroneker.
