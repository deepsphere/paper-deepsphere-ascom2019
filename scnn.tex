...
We however trained an SVM on the raw pixels and were unable to obtain over $60\%$ accuracy in the easiest cases (i.e., noiseless).
(Remember that every other tested model is close to $100\%$ in that setting.)
% TODO: provide an explanation why?
...
It is irrelevant when working on the complete sphere as this surface has no border. Nevertheless, when working with a subpart of the sphere, its border slightly affects the convolution.
