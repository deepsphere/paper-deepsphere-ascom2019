...
$h: \R_+ \rightarrow \R$, a signal $\f$ is filtered as
...
Depending on the convolution kernel, this may reveal much more efficient.
\todo{Show the figure comparing speed of low-pass filtering? It's 10x faster.}
...
% not ideal as the graph convolution depends on the localization
