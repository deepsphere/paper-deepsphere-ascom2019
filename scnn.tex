...
\citet{kondor2018clebsch} proposed to use the Clebsh-Gordan transform to perform a non-linear transformation in the spectral domain. As such, a SHT only has to be performed once to transform the data in the spectral domain. No need to transform back and forth between every layer. While a clever trick, it is unclear if it results in any speed gain in practice. \todo{computation complexity? no speed comparison in paper?}
