...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
    ...
    \item (MD) check vertex interpretation in Efficient convolutions. Powers of L are weights of paths. We deal with neighborhoods rather than individual nodes.
