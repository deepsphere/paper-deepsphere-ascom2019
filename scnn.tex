...
\figref{g:graph_harmonics} displays the first 16 eigenvectors of the
...
sampling (see \figref{healpix_graph_4}) have two important effects on the
...
\figref{index_section}, we display the selected indexes for the section
