...
Any convolution using directions on the sphere is not equivariant to rotation.
...
\todo{In HealpixNet we use the idea of a statistical layer, described in \secref{stat_layer}, to provide invariance to isometric transformations such as rotation on the sphere.
