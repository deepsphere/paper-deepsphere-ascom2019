...
\end{equation}
which is a convolution of the signal $\b{f}(0)$ with the kernel 
$K_t(x)=e^{-\tau t x}$. Here the kernel $K_t$ is applied to the correspond
In Figure~\ref{fig:gaussian_filters_comparizon}, we show the effect of the convolution by diffusing a unit of heat for various amount of time. 
