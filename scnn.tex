...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
    ...
    \item (NP) make figure A.13 remove white space
    \item (TK) re-make figures to make the labels/legend/titles the same font size as the main text
    \item (NP+MD)  paragraph on our chosen architecture in the Experiments sections
    \item (NP+MD) move the Related Work section after the Method section
    ...
    \item (TK) uniformize text size in figures
