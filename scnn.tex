...
% The statistical layer was used in the end. The FCN is a more principled approach.
...
% A statistical layer (ST) is optionally inserted between the convolutional head and the fully connected tail.
...
In all our experiments, we saw no sign of over-fitting.
