...
\begin{figure}[t!]
	...
	The timings for the partial graphs correspond to the convolution on only a fraction (1/12, 1/48, 1/192) of the sphere. This illustrates how graph convolution scales with $N_{pix}$.
	}
...
We also observe an important gain for graph convolution if it only needs to process only a subpart of the sphere. 
This gain is the direct reflection of the graph convolution complexity proportional to $N_{pix}$.
