...
Analysis of larger survey area in this form requires dividing the data into smaller chunks and projecting them on a flat, 2D surface.
...
The most commonly used scheme in astrophysics to divide a sphere into pixels is \pkg{Healpix} \citep{gorski2005healpix}, which uses pixels with the same area.

In this work we present an algorithm and software package to implement efficient deep convolutional neural networks on Healpix maps.
...
They exist three approaches to address this issue.
