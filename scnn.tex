...
\todo{The statistical layer, an idea that we reused in this work. See xxx.}
...
\todo{(i) scale of $\theta_k$: they are mostly constant for Chebyshev polynomials. How are they for monomials?}
