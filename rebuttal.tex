...
\TK{PS and histograms are standard statistics used by the cosmology community for analysing real data. This is why we chose it as the reference point.
The single step of moving away from these hand-picked statistics to ML approaches is already interesting for physicists.
...
With average pooling, all pixels are equal.
...
\TK{Thank you for the suggestion, we adopted it.}
...
\TK{We updated the text as suggested.}
...
\end{mdframed}
\TK{Indeed. We added a word "typically" to reflect that there may be cases like this.}
