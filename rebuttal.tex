...
\nati{I do not think we can practically compare with Clebsh-Gordan transform. There is no code for the paper of Kondor. We can write the theoretical complexity. This is a sensitive point.}
...
\nati{
This is something we should be able to do. Actually, since we used 1/12 of the sphere, all the pixel grids we use are somehow squared. I am now using this as a projection. @Tomek, do you know if this is ok? Or do you know how to do the projection in a simple and efficient manner? 
I am trying to make the comparizon right now
More important, I think that traditional 2D CNNs will be as good as our algorithm. We should be very careful in the way we formulate this in our answer and in the paper.}
...
\end{mdframed}
\nati{@Nati, @Michael, @Tomek

Problem here is that rotation is not simple on a sphere, it will probably be slow and I will have to break a lot of code to do it.
Nevertheless, I believe that in theory, CNN will match FCN when we do enought rotation. Should we answer that? @mMichael: what do you think?
}
...
\todo{Dear reviewer, this is an excellente question. We have have made the choice to takle quantitatively and theoretically the subject of convergence because of its complexity. 

Very good question: but too complex answer for this paper. This is kept for a future contribution. + explain why}
