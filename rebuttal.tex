...
The robustness to noise is also crucial, as demonstrated in [9]. We added a footnote to specify this.
...
\end{mdframed}
We agree with the reviewer that (iii) and (iv) are also optional. Hence we reformulated this sentence as:
\begin{mdframed}[style=manuscript]
A CNN is composed of the following main building blocks~\cite{lecun1998cnn}:
(i) a convolution,
(ii) a non-linearity.
